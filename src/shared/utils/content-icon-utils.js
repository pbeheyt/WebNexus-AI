...
export function getContentTypeIconSvg(contentType) {
  ...
  switch (contentType) {
    ...
    default:
      ...
      iconSvg = `
        <svg class="general-icon w-5 h-5" viewBox="0 0 512 512" fill="var(--icon-general-fill-color)" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" xml:space="preserve">
          <g>
            <g>
