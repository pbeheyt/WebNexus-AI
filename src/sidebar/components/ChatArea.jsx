  ...
  const getContentTypeIconSvg = (contentType) => {
    ...
    switch (contentType) {
      case CONTENT_TYPES.YOUTUBE:
        iconSvg = `
          <svg class="youtube-icon w-12 h-12" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" viewBox="0 0 461.001 461.001" xml:space="preserve">
            <g>
      ...
      case CONTENT_TYPES.REDDIT:
        // Replaced SVG & Kept size
        iconSvg = `
          <svg class="reddit-icon w-12 h-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 800">
      ...
      case CONTENT_TYPES.PDF:
        iconSvg = `
          <svg class="pdf-icon w-12 h-12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      default:
        iconSvg = `
          <svg class="general-icon w-12 h-12" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <>
            {selectedPlatformId && selectedPlatform.iconUrl ? (
              <>
                ...
                {selectedModel && (
                  <div className="text-sm text-theme-secondary mb-8"> {/* Further increased margin */}
                    {selectedModel}
                  </div>
                )}
              </>
            ...
            {getContentTypeIconSvg(contentType) && (
              <div
                className="mt-0" // Removed top margin
