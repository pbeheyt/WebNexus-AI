...
export const AssistantMessageBubble = memo(forwardRef(({
    id,
    content,
    isStreaming = false,
    model = null,
    ...
    return (
        ...
        >
            ...
            <div className="flex justify-between items-center pb-4">
                ...
                <div className={`flex items-center justify-center gap-1 transition-opacity duration-150 ${isProcessing ? 'opacity-0 pointer-events-none' : assistantCopyState === 'copied' || assistantCopyState === 'error' ? 'opacity-100' : 'opacity-0 group-hover:opacity-100 focus-within:opacity-100'}`}>
