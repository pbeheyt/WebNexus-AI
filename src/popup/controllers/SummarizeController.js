...
export default class SummarizeController {
        ...
        if (useApi) {
          ...
          let checkApiResponse = async () => {
            ...
            if (apiStatus === 'completed') {
              ...
              await this.handleApiResponseComplete(apiResponse);
              return;
            ...
            // Use reference to this bound function
  ...
  async handleApiResponseComplete(apiResponse) {
    try {
      ...
      console.log("Preparing to activate sidebar with API response");

      // First inject the sidebar script if needed
      console.log("Injecting sidebar script");
      ...
      // Log the message sending step
      console.log("Sending message to show sidebar", {
