...
export function ContentTypeDisplay() {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center gap-2 p-2 bg-background-surface border border-border rounded-md text-sm">
  ...
  return (
    <div 
      className="flex items-center gap-2 p-2 bg-background-surface border border-border rounded-md text-sm"
