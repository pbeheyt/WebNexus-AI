  ...
  useEffect(() => {
    const initialize = async () => {
      try {
        ...
        const credentialResult = await chrome.storage.local.get(
        ...
        const advancedResult = await chrome.storage.sync.get(
          STORAGE_KEYS.API_ADVANCED_SETTINGS
        );
        setAdvancedSettings(
          advancedResult[STORAGE_KEYS.API_ADVANCED_SETTINGS] || {}
        );
      } catch (err) {
